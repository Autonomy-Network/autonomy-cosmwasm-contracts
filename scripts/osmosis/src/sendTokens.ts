import { coins, GasPrice, StdFee, calculateFee } from "@cosmjs/stargate";
...
async function main() {
  ...
  const client = await SigningCosmWasmClient.connectWithSigner(lcdApi, wallet, {
  ...
  await client.sendTokens(
    address,
    recipient,
    coins(10, "factory/osmo1phaxpevm5wecex2jyaqty2a4v02qj7qmlmzk5a/auto"),
    defaultSendFee
  );
}
